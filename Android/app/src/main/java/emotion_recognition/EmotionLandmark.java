...
/**
 * Recognize emotion with facial landmarks using SVM classification.
 * Make sure the landmark is correctly detected in Landmark class before
 * passing landmark to this class for recognition
 *
 * @author tanzhenxing
 * 2018-09-30
 */
